...
def main():
    ...
    with open('difftestdata.csv', 'r') as file:
    ...
    for pair in space_list:
        ...
        try:
            next_bearing = coords_list.get_current_bearing()
        except geolists.UnchangedPointError:
            next_bearing = next_bearing
            print("DIFFERROR")
        bearing_list.add_bearing(next_bearing)
